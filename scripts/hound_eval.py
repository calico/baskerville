...
def main():
  ...
  parser.add_argument('--tfr_pattern',
                      default=None,
  ...
  parser.add_argument('model_file',
      help='Trained model HDF5.')
  parser.add_argument('data_dir',
      help='Train/valid/test data directory')
  ...
  # construct eval data
  eval_data = dataset.SeqDataset(args.data_dir,
  ...
  targets_acc_df.to_csv('%s/acc.txt'%args.out_dir, sep='\t',
  ...
  if args.save:
    ...
    if args.bedgraph_indexes is not None:
      ...
      bed.write_bedgraph(test_preds, test_targets, args.data_dir,
        bedg_out, args.split, bedgraph_indexes)
